...
/* 151 */     public static synchronized String getString(ContentResolver resolver, String name) { throw new RuntimeException("Stub!"); } 
/* 152 */     public static boolean putString(ContentResolver resolver, String name, String value) { throw new RuntimeException("Stub!"); } 
/* 153 */     public static Uri getUriFor(String name) { throw new RuntimeException("Stub!"); } 
/* 154 */     public static int getInt(ContentResolver cr, String name, int def) { throw new RuntimeException("Stub!"); } 
/* 155 */     public static int getInt(ContentResolver cr, String name) throws Settings.SettingNotFoundException { throw new RuntimeException("Stub!"); } 
/* 156 */     public static boolean putInt(ContentResolver cr, String name, int value) { throw new RuntimeException("Stub!"); } 
/* 157 */     public static long getLong(ContentResolver cr, String name, long def) { throw new RuntimeException("Stub!"); } 
/* 158 */     public static long getLong(ContentResolver cr, String name) throws Settings.SettingNotFoundException { throw new RuntimeException("Stub!"); } 
/* 159 */     public static boolean putLong(ContentResolver cr, String name, long value) { throw new RuntimeException("Stub!"); } 
/* 160 */     public static float getFloat(ContentResolver cr, String name, float def) { throw new RuntimeException("Stub!"); } 
/* 161 */     public static float getFloat(ContentResolver cr, String name) throws Settings.SettingNotFoundException { throw new RuntimeException("Stub!"); } 
/* 162 */     public static boolean putFloat(ContentResolver cr, String name, float value) { throw new RuntimeException("Stub!"); } 
/* 163 */     public static final boolean isLocationProviderEnabled(ContentResolver cr, String provider) { throw new RuntimeException("Stub!"); } 
/* 164 */     public static final void setLocationProviderEnabled(ContentResolver cr, String provider, boolean enabled) { throw new RuntimeException("Stub!");
/*     */     }
/*     */   }
/*     */ 
...
/*  85 */     public static final String[] VOLUME_SETTINGS = null;
...
/*  22 */     public static synchronized String getString(ContentResolver resolver, String name) { throw new RuntimeException("Stub!"); } 
...
/*  36 */     public static boolean getShowGTalkServiceStatus(ContentResolver cr) { throw new RuntimeException("Stub!"); } 
/*  37 */     public static void setShowGTalkServiceStatus(ContentResolver cr, boolean flag) { throw new RuntimeException("Stub!");
/*     */     }
/*     */ 
/*     */     static
/*     */     {
/* 145 */       CONTENT_URI = null; DEFAULT_RINGTONE_URI = null; DEFAULT_NOTIFICATION_URI = null; DEFAULT_ALARM_ALERT_URI = null;
/*     */     }
/*     */   }
/*     */ 
